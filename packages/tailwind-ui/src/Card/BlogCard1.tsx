export default function BlogCard1() {
  return (
    <div className=" from-red-100 via-red-300 to-blue-500 bg-gradient-to-br p-4 items-center justify-center w-[680px] rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
      <img
