...
export function Team03() {
  return (
    <Card className="w-full max-w-sm flex-row items-center gap-4 p-4">
      ...
      <View className="flex-1 gap-2">
        <View>
          <Text className="text-lg font-semibold">John Smith</Text>
          <Text className="text-muted-foreground text-sm">Lead Developer</Text>
        </View>
