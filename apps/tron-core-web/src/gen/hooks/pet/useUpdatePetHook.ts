...
export async function updatePetHook(data: UpdatePetMutationRequest, config: Partial<RequestConfig<UpdatePetMutationRequest>> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<UpdatePetMutationResponse, ResponseErrorConfig<UpdatePet400 | UpdatePet404 | UpdatePet405>, UpdatePetMutationRequest>({ method : "PUT", url : `/pet`, baseURL : "https://petstore3.swagger.io/api/v3", data : requestData, ... requestConfig })  
  return res.data
}
...
export function useUpdatePetHook<TContext>(options: 
{
 ...
 = {}) {
  ...
  const baseOptions = updatePetMutationOptionsHook(config) as UseMutationOptions<UpdatePetMutationResponse, ResponseErrorConfig<UpdatePet400 | UpdatePet404 | UpdatePet405>, {data: UpdatePetMutationRequest}, TContext>
  ...
  return useMutation<UpdatePetMutationResponse, ResponseErrorConfig<UpdatePet400 | UpdatePet404 | UpdatePet405>, {data: UpdatePetMutationRequest}, TContext>({
    ...
    mutationKey,
    ...mutationOptions,
  }, queryClient) as UseMutationResult<UpdatePetMutationResponse, ResponseErrorConfig<UpdatePet400 | UpdatePet404 | UpdatePet405>, {data: UpdatePetMutationRequest}, TContext>
}