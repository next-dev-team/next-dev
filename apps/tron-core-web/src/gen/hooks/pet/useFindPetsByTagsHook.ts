...
export async function findPetsByTagsHook(params?: FindPetsByTagsQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<FindPetsByTagsQueryResponse, ResponseErrorConfig<FindPetsByTags400>, unknown>({ method : "GET", url : `/pet/findByTags`, baseURL : "https://petstore3.swagger.io/api/v3", params, ... requestConfig })  
  return res.data
}
 ...
 * {@link /pet/findByTags}
 */
export function useFindPetsByTagsHook<TData = FindPetsByTagsQueryResponse, TQueryData = FindPetsByTagsQueryResponse, TQueryKey extends QueryKey = FindPetsByTagsQueryKey>(params?: FindPetsByTagsQueryParams, options: 
{
  query?: Partial<QueryObserverOptions<FindPetsByTagsQueryResponse, ResponseErrorConfig<FindPetsByTags400>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },
 ...
 = {}) {
  ...
  const query = useQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as QueryObserverOptions, queryClient) as UseQueryResult<TData, ResponseErrorConfig<FindPetsByTags400>> & { queryKey: TQueryKey }
