...
export async function loginUserHook(params?: LoginUserQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<LoginUserQueryResponse, ResponseErrorConfig<LoginUser400>, unknown>({ method : "GET", url : `/user/login`, baseURL : "https://petstore3.swagger.io/api/v3", params, ... requestConfig })  
  return res.data
}
 ...
 * {@link /user/login}
 */
export function useLoginUserHook<TData = LoginUserQueryResponse, TQueryData = LoginUserQueryResponse, TQueryKey extends QueryKey = LoginUserQueryKey>(params?: LoginUserQueryParams, options: 
{
 ...
 = {}) {
  ...
  const query = useQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as QueryObserverOptions, queryClient) as UseQueryResult<TData, ResponseErrorConfig<LoginUser400>> & { queryKey: TQueryKey }
