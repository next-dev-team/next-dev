 ...
 * {@link /user/login}
 */
export function useLoginUserSuspenseHook<TData = LoginUserQueryResponse, TQueryKey extends QueryKey = LoginUserSuspenseQueryKey>(params?: LoginUserQueryParams, options: 
{
 ...
 = {}) {
  ...
  const query = useSuspenseQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as UseSuspenseQueryOptions, queryClient) as UseSuspenseQueryResult<TData, ResponseErrorConfig<LoginUser400>> & { queryKey: TQueryKey }
