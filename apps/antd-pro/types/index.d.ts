declare namespace API {
  ...
  export type GET_API_CURRENT_USER_RES = {
    /** example: {"name": "Serati Ma", "avatar": "https: //gw.alipayobjects.com/zos/rmsportal/BiazfanxmamNRoxxVxka.png", "userid": "00000001", "email": "antdesign@alipay.com", "signature": "Be tolerant to diversity, tolerance is a virtue", "title": "Interaction Expert", "group": "Ant Financial - XX Business Group - XX Platform Dept - XX Tech Dept - UED", "tags": [{"key": "0", "label": "Creative"}, {"key": "1", "label": "Focus on Design"}, {"key": "2", "label": "Hot~"}, {"key": "3", "label": "Long Legs"}, {"key": "4", "label": "Sichuan Girl"}, {"key": "5", "label": "Tolerant to Diversity"}], "notifyCount": 12, "unreadCount": 11, "country": "China", "geographic": {"province": {"label": "Zhejiang Province", "key": "330000"}, "city": {"label": "Hangzhou City", "key": "330100"}}, "address": "77 Gongzhuan Road, Xihu District", "phone": "0752-268888888"} */
    data: {
      name: string;
      avatar: string;
      userid: string;
