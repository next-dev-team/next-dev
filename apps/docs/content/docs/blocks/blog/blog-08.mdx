...
import { Blog08 } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full"><Blog08 /></div>} />
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/blog/blog-08.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
