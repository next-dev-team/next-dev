...
import { Blog07 } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full"><Blog07 /></div>} />
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/blog/blog-07.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
