...
import { Blog10 } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full"><Blog10 /></div>} />
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/blog/blog-10.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
