...
<BlockPreviewCard preview={<div className="w-full"><Testimonials02 /></div>} />
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    <CommandTabs args={["add", "testimonials-02"]}/>
  </TabsContent>
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/testimonials/testimonials-02.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
