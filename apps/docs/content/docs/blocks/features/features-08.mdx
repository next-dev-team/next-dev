...
import { Features08 } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full"><Features08 /></div>} />
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    <CommandTabs args={["add", "features-08"]}/>
  </TabsContent>
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/features/features-08.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
