...
import { Stats08 } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full"><Stats08 /></div>} />
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/stats/stats-08.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
