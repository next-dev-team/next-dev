...
import { Contact10 } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full"><Contact10 /></div>} />
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    <CommandTabs args={["add", "contact-10"]}/>
  </TabsContent>
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/contact/contact-10.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
