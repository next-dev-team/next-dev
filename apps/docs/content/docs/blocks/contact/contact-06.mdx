...
import { Contact06 } from "@docs/components/blocks";
...
<BlockPreviewCard preview={<div className="w-full"><Contact06 /></div>} />
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    <CommandTabs args={["add", "contact-06"]}/>
  </TabsContent>
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/contact/contact-06.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
