---
title: POS Actions
description: Action buttons for POS operations.
---

import { BlockPreviewCard } from '@docs/components/preview-card';
import { Pos06 } from '@docs/components/blocks';
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/pos/pos-06.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
