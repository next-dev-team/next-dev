...
description: Payment method selection grid.
---

import { BlockPreviewCard } from '@docs/components/preview-card';
import { Pos08 } from '@docs/components/blocks';
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/pos/pos-08.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
