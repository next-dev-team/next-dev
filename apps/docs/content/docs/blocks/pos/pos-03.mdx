---
title: POS Cart Item
description: Cart item row with quantity controls.
---

import { BlockPreviewCard } from '@docs/components/preview-card';
import { Pos03 } from '@docs/components/blocks';
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/pos/pos-03.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
