...
description: Horizontal scrollable category list with circular images.
---

import { BlockPreviewCard } from '@docs/components/preview-card';
import { ShopUi01 } from '@docs/components/blocks';
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    <CommandTabs args={["add", "shop-ui-01"]} />
  </TabsContent>
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/shop-ui/shop-ui-01.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
