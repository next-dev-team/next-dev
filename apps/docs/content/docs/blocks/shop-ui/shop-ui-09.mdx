...
description: Breadcrumb navigation for shop pages.
---

import { BlockPreviewCard } from '@docs/components/preview-card';
import { ShopUi09 } from '@docs/components/blocks';
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    <CommandTabs args={["add", "shop-ui-09"]} />
  </TabsContent>
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/shop-ui/shop-ui-09.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
