---
title: Shop Sort Dropdown
description: Dropdown menu for sorting product lists.
---

import { BlockPreviewCard } from '@docs/components/preview-card';
import { ShopUi03 } from '@docs/components/blocks';
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    <CommandTabs args={["add", "shop-ui-03"]} />
  </TabsContent>
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/shop-ui/shop-ui-03.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
