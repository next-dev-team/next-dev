---
title: Shop Wishlist Item
description: Wishlist item row with actions.
---

import { BlockPreviewCard } from '@docs/components/preview-card';
import { ShopUi05 } from '@docs/components/blocks';
...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    <CommandTabs args={["add", "shop-ui-05"]} />
  </TabsContent>
    ...
    <Steps>
      <Step>
        **Copy and paste the following code into your project.**
        ...
        ```json doc-gen:file
        {
          "file": "./node_modules/@rnr/registry/src/blocks/shop-ui/shop-ui-05.tsx",
          "codeblock": {
            "lang": "tsx"
          }
        }
