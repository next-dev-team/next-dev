...
<div className="text-fd-muted-foreground">
  This creates a new project in the current directory. For more details, see the [init
  options](/docs/cli#init).
</div>
...
<div className="pt-px">
  The command above will add the `Button` component to your project. You can then import it like
  this:
</div>
